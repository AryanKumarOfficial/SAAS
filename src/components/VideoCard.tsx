...
const VideoCardComponent: React.FC<VideoCardProps> = ({video, onDownload}) => {
    ...
    return (
        ...
        >
            <figure className={"aspect-video relative"}>
                ...
                <div
                    className={"absolute bottom-2 right-2 bg-base-100 bg-opacity-70 px-2 py-1 rounded-lg text-sm flex items-center"}>
                    <Clock
                        size={16}
                        className={"mr-1"}
                    />
            ...
            <div className={"card-body p-4"}>
                ...
                <div className={"grid grid-cols-2 gap-4 text-sm"}>
                    ...
                    <div className={"flex items-center"}>
                        <FileDown
                            size={18}
                            className={"mr-2 textarea-secondary"}/>
                        <div>
